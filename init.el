...
(custom-set-variables
 ...
 '(package-selected-packages
   '(toml-mode rust-playground company yasnippet flycheck lsp-ui rustic gnu-elpa-keyring-update exec-path-from-shell lsp-mode ivy-rich which-key rainbow-delimiters evil-nerd-commenter doom-modeline counsel ivy command-log-mode use-package)))
(custom-set-faces
